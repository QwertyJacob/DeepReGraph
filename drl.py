...
class AdaGAE():
    ...
    def build_loss(self, recons):
        ...
        loss += lam * local_distance_preserving_loss
    ...
    def cal_weights_via_CAN(self, transposed_data_matrix):
        ...
        current_link_score = fast_genomic_distance_to_similarity(links, genomic_C, genomic_slope)

        if genetic_balance_factor != 0:
